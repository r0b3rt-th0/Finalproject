...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .ignoresSafeArea(edges: [.top]) // avoids extending under the TabView
...
*/
            ...
            .safeAreaInset(edge: .bottom) {
                Color.clear.frame(height: 50) // ✅ Adds space above TabView
            }
        }
    }
...
struct ContactView: View {
    ...
    var body: some View {
        ...
        .safeAreaInset(edge: .bottom) {
            Color.clear.frame(height: 50) // ✅ Keeps it above TabView
        }
    }
}
